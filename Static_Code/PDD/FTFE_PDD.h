...
/* ----------------------------------------------------------------------------
  ...
  #error FTFE PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MK21F12) /* FTFE */ && \
      !defined(MCU_MK21F12WS) /* FTFE */ && \
      !defined(MCU_MK22F12) /* FTFE */ && \
      !defined(MCU_MK24F12) /* FTFE */ && \
      ...
      !defined(MCU_MK63F12) /* FTFE */ && \
      !defined(MCU_MK63F12WS) /* FTFE */ && \
      !defined(MCU_MK64F12) /* FTFE */ && \
      !defined(MCU_MK65F18) /* FTFE */ && \
      !defined(MCU_MK65F18WS) /* FTFE */ && \
      !defined(MCU_MK66F18) /* FTFE */ && \
...
#define FTFE_PDD_READ_MARGIN_LEVEL_NORMAL  0U    /**< Normal read level constant */
#define FTFE_PDD_READ_MARGIN_LEVEL_USER    0x1U  /**< User read level constant */
#define FTFE_PDD_READ_MARGIN_LEVEL_FACTORY 0x2U  /**< Factory read level constant */

/* Read resource command resource code constants */
#define FTFE_PDD_RESOURCE_IFR        0U          /**< IFR */
#define FTFE_PDD_RESOURCE_VERSION_ID 0x1U        /**< Version ID */

/* EEPROM size constants */
#define FTFE_PDD_EEPROM_DATA_SIZE_0_B     0xFU   /**< No EEPROM */
#define FTFE_PDD_EEPROM_DATA_SIZE_32_B    0x9U   /**< 32 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_64_B    0x8U   /**< 64 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_128_B   0x7U   /**< 128 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_256_B   0x6U   /**< 256 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_512_B   0x5U   /**< 512 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_1024_B  0x4U   /**< 1024 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_SIZE_2048_B       0x3U   /**< 2048 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_4096_B  0x2U   /**< 4096 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_8192_B  0x1U   /**< 8192 bytes of EEPROM data */
#define FTFE_PDD_EEPROM_DATA_SIZE_16384_B 0U     /**< 16384 bytes of EEPROM data */

/* EEPROM backup size constants */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_0_KB   0U    /**< No EEPROM */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_8_KB   0x1U  /**< 8 KB of EEPROM backup */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_16_KB  0x2U  /**< 16 KB of EEPROM backup */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_32_KB  0x3U  /**< 32 KB of EEPROM backup */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_64_KB  0x4U  /**< 64 KB of EEPROM backup */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_128_KB 0x5U  /**< 128 KB of EEPROM backup */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_256_KB 0x6U  /**< 256 KB of EEPROM backup */
#define FTFE_PDD_EEPROM_BACKUP_SIZE_512_KB 0x7U  /**< 512 KB of EEPROM backup */
#define FTFE_PDD_DATA_FLASH_SIZE_0_KB      0x8U  /**< No data falsh */
#define FTFE_PDD_DATA_FLASH_SIZE_8_KB      0x9U  /**< 8 KB of data falsh */
#define FTFE_PDD_EDATA_FLASH_SIZE_16_KB    0xAU  /**< 16 KB of data falsh */
#define FTFE_PDD_DATA_FLASH_SIZE_32_KB     0xBU  /**< 32 KB of data falshp */
#define FTFE_PDD_DATA_FLASH_SIZE_64_KB     0xCU  /**< 64 KB of data falsh */
#define FTFE_PDD_DATA_FLASH_SIZE_128_KB    0xDU  /**< 128 KB of data falsh */
#define FTFE_PDD_EDATA_FLASH_SIZE_256_KB   0xEU  /**< 256 KB of data falsh */
#define FTFE_PDD_DATA_FLASH_SIZE_512_KB    0xFU  /**< 512 KB of data falsh */
#define FTFE_PDD_DATA_FLASH_SIZE_MAX       0xFU  /**< No EEPROM backup data falsh only */

/* FlexRAM function constants */
#define FTFE_PDD_FLEXRAM_AS_RAM    0xFFU         /**< Make FlexRAM available as RAM */
#define FTFE_PDD_FLEXRAM_AS_EEPROM 0U            /**< Make FlexRAM available for EEPROM */
...
#define FTFE_PDD_MASS_ERASE_ENABLED  0U          /**< Mass erase enable constant */
#define FTFE_PDD_MASS_ERASE_DISABLED 0x1U        /**< Mass erase disable constant */

/* Factory access constants */
#define FTFE_PDD_FACTORY_ACCESS_GRANTED 0U       /**< Factory access granted constant */
#define FTFE_PDD_FACTORY_ACCESS_DENIED  0x1U     /**< Factory access denied constant */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadStatusReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteStatusReg(<peripheral>_BASE_PTR,
 *      FTFE_PDD_COMMAND_COMPLETE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_ClearCommandCompleteFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_ClearReadCollisionErrorFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_ClearAccessErrorFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_ClearProtectionViolationErrorFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_LaunchCommand(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_ClearFlags(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetFlags(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadConfigReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteConfigReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_EnableInterrupts(<peripheral>_BASE_PTR,
 *      FTFE_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_DisableInterrupts(<peripheral>_BASE_PTR,
 *      FTFE_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetEraseAllRequest(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetEraseAllRequest(PeripheralBase) ( \
    (uint8_t)(FTFE_FCNFG_REG(PeripheralBase) & FTFE_FCNFG_ERSAREQ_MASK) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_SuspendErasing(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetRAMReady(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetEEEReady(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadSecurityReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint16_t result = FTFE_PDD_GetBackdoorEnable(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint16_t result = FTFE_PDD_GetMassEraseEnable(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetMassEraseEnable(PeripheralBase) ( \
    (( \
      (uint8_t)(( \
       (uint8_t)(FTFE_FSEC_REG(PeripheralBase) & FTFE_FSEC_MEEN_MASK)) >> ( \
       FTFE_FSEC_MEEN_SHIFT))) == ( \
      0x2U)) ? ( \
      FTFE_PDD_MASS_ERASE_DISABLED) : ( \
      FTFE_PDD_MASS_ERASE_ENABLED) \
  )
 ...
 * @par Example:
 *      @code
 *      uint16_t result = FTFE_PDD_GetFactoryAccess(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetFactoryAccess(PeripheralBase) ( \
    ((uint8_t)(FTFE_FSEC_REG(PeripheralBase) & FTFE_FSEC_FSLACC_MASK) == 0U) ? ( \
      FTFE_PDD_FACTORY_ACCESS_GRANTED) : ((( \
      (uint8_t)(( \
       (uint8_t)(FTFE_FSEC_REG(PeripheralBase) & FTFE_FSEC_FSLACC_MASK)) >> ( \
       FTFE_FSEC_FSLACC_SHIFT))) == ( \
      0x3U)) ? ( \
      FTFE_PDD_FACTORY_ACCESS_GRANTED) : ( \
      FTFE_PDD_FACTORY_ACCESS_DENIED) \
    ) \
  )
 ...
 * @par Example:
 *      @code
 *      uint16_t result = FTFE_PDD_GetSecurityState(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadOptionReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB0Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB1Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB2Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB3Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB4Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB5Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB6Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB7Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB8Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOB9Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOBAReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_ReadFCCOBBReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB0Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB1Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB2Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB3Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB4Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB5Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB6Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB7Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB8Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOB9Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBAReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBBReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_SetFCCOBCommand(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_SetFCCOBAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData0(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData1(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData2(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData3(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData4(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData5(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData6(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBData7(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBLongWordData(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBFirstLongWordData(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteFCCOBSecondLongWordData(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_SetPFlashProtectionState(<peripheral>_BASE_PTR, 1,
 *      FTFE_PDD_UNPROTECTED);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_GetPFlashProtectionState(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 *        (<component_name>_DEVICE).
 * @return Returns a 8-bit value.
 * @remarks The macro accesses the following registers: FTFE_FPROT0.
 * @par Example:
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_ReadProgramFlashProtection0Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_ReadProgramFlashProtection0Reg(PeripheralBase) ( \
    FTFE_FPROT0_REG(PeripheralBase) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteProgramFlashProtection0Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_WriteProgramFlashProtection0Reg(PeripheralBase, Value) ( \
    FTFE_FPROT0_REG(PeripheralBase) = \
     (uint8_t)(Value) \
  )
 ...
 *        (<component_name>_DEVICE).
 * @return Returns a 8-bit value.
 * @remarks The macro accesses the following registers: FTFE_FPROT1.
 * @par Example:
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_ReadProgramFlashProtection1Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_ReadProgramFlashProtection1Reg(PeripheralBase) ( \
    FTFE_FPROT1_REG(PeripheralBase) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteProgramFlashProtection1Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_WriteProgramFlashProtection1Reg(PeripheralBase, Value) ( \
    FTFE_FPROT1_REG(PeripheralBase) = \
     (uint8_t)(Value) \
  )
 ...
 *        (<component_name>_DEVICE).
 * @return Returns a 8-bit value.
 * @remarks The macro accesses the following registers: FTFE_FPROT2.
 * @par Example:
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_ReadProgramFlashProtection2Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_ReadProgramFlashProtection2Reg(PeripheralBase) ( \
    FTFE_FPROT2_REG(PeripheralBase) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteProgramFlashProtection2Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_WriteProgramFlashProtection2Reg(PeripheralBase, Value) ( \
    FTFE_FPROT2_REG(PeripheralBase) = \
     (uint8_t)(Value) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_ReadProgramFlashProtection3Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_ReadProgramFlashProtection3Reg(PeripheralBase) ( \
    FTFE_FPROT3_REG(PeripheralBase) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_WriteProgramFlashProtection3Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_WriteProgramFlashProtection3Reg(PeripheralBase, Value) ( \
    FTFE_FPROT3_REG(PeripheralBase) = \
     (uint8_t)(Value) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_SetDFlashProtectionState(<peripheral>_BASE_PTR, 1,
 *      FTFE_PDD_UNPROTECTED);
 *      @endcode
 */
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_GetDFlashProtectionState(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_SetEERAMProtectionState(<peripheral>_BASE_PTR, 1,
 *      FTFE_PDD_UNPROTECTED);
 *      @endcode
 */
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_GetEERAMProtectionState(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetErrorFlags(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetErrorFlags(PeripheralBase) ( \
    (uint8_t)(( \
     FTFE_FSTAT_REG(PeripheralBase)) & ( \
     (uint8_t)(( \
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_ClearErrorFlags(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_ClearErrorFlags(PeripheralBase) ( \
    FTFE_FSTAT_REG(PeripheralBase) = \
     (uint8_t)(FTFE_FSTAT_RDCOLERR_MASK | (FTFE_FSTAT_ACCERR_MASK | FTFE_FSTAT_FPVIOL_MASK)) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetCmdCompleteFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetCmdCompleteFlag(PeripheralBase) ( \
    (uint8_t)(FTFE_FSTAT_REG(PeripheralBase) & FTFE_FSTAT_CCIF_MASK) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_GetReadCollisionErrorFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetReadCollisionErrorFlag(PeripheralBase) ( \
    (uint8_t)(FTFE_FSTAT_REG(PeripheralBase) & FTFE_FSTAT_RDCOLERR_MASK) \
  )
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetAccessErrorFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetAccessErrorFlag(PeripheralBase) ( \
    (uint8_t)(FTFE_FSTAT_REG(PeripheralBase) & FTFE_FSTAT_ACCERR_MASK) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_GetProtectionViolationFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetProtectionViolationFlag(PeripheralBase) ( \
    (uint8_t)(FTFE_FSTAT_REG(PeripheralBase) & FTFE_FSTAT_FPVIOL_MASK) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_GetCmdCompleteStatusFlag(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetCmdCompleteStatusFlag(PeripheralBase) ( \
    (uint8_t)(FTFE_FSTAT_REG(PeripheralBase) & FTFE_FSTAT_MGSTAT0_MASK) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_StartCmd(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_StartCmd(PeripheralBase) ( \
    FTFE_FSTAT_REG(PeripheralBase) = \
 ...
 * @par Example:
 *      @code
 *      uint8_t result = FTFE_PDD_GetCmdCode(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_GetCmdCode(PeripheralBase) ( \
    FTFE_FCCOB0_REG(PeripheralBase) \
  )
 ...
 *        the peripheral initialization component header file
 *        (<component_name>_DEVICE).
 * @param Address Address in the flash block to be verified. Must be 128 bits
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sBlock_Init(<peripheral>_BASE_PTR, 1,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sBlock_Init(PeripheralBase, Address, MarginLevel) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_READ_1S_BLOCK << 24), \
    (FTFE_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel)) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_Read1sBlock_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sBlock_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFE_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sBlock_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sBlock_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_READ_1S_BLOCK << 24) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_Cmd_Read1sBlock_GetMarginLevel(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sBlock_GetMarginLevel(PeripheralBase) ( \
    (FTFE_FCCOB4_REG(PeripheralBase)) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sBlock_SetMarginLevel(<peripheral>_BASE_PTR,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sBlock_SetMarginLevel(PeripheralBase, MarginLevel) ( \
    FTFE_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sSection_Init(<peripheral>_BASE_PTR, 1, 1,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_Init(PeripheralBase, Address, SectionUnitCount, MarginLevel) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_READ_1S_SECTION << 24), \
    *(uint32_t*)&FTFE_FCCOB7_REG(PeripheralBase) = (SectionUnitCount << 16) | (MarginLevel << 8) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_Read1sSection_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFE_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sSection_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_READ_1S_SECTION << 24) \
  )
 ...
 *      @code
 *      uint16_t result =
 *      FTFE_PDD_Cmd_Read1sSection_GetSize(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_GetSize(PeripheralBase) ( \
    (uint16_t)((*(uint16_t *)(void *)&(FTFE_FCCOB5_REG(PeripheralBase)))) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sSection_SetSize(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_SetSize(PeripheralBase, SectionUnitCount) ( \
    *(uint16_t*)&FTFE_FCCOB5_REG(PeripheralBase) = (SectionUnitCount) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_Cmd_Read1sSection_GetMarginLevel(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_GetMarginLevel(PeripheralBase) ( \
    (FTFE_FCCOB6_REG(PeripheralBase)) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sSection_SetMarginLevel(<peripheral>_BASE_PTR,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sSection_SetMarginLevel(PeripheralBase, MarginLevel) ( \
    FTFE_FCCOB6_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramCheck_Init(<peripheral>_BASE_PTR, 1, 1,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_Init(PeripheralBase, Address, Data, MarginLevel) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_PROGRAM_CHECK << 24), \
    ((FTFE_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel)), \
    *(uint32_t*)&FTFE_FCCOBB_REG(PeripheralBase) = Data) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_ProgramCheck_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFE_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramCheck_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_PROGRAM_CHECK << 24) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_ProgramCheck_GetData(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_GetData(PeripheralBase) ( \
    (uint32_t)(*(uint32_t *)(void *)&FTFE_FCCOBB_REG(PeripheralBase)) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramCheck_SetData(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_SetData(PeripheralBase, Data) ( \
    *(uint32_t*)&FTFE_FCCOBB_REG(PeripheralBase) = Data \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_Cmd_ProgramCheck_GetMarginLevel(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_GetMarginLevel(PeripheralBase) ( \
    (FTFE_FCCOB4_REG(PeripheralBase)) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramCheck_SetMarginLevel(<peripheral>_BASE_PTR,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramCheck_SetMarginLevel(PeripheralBase, MarginLevel) ( \
    FTFE_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel) \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_Init
   ---------------------------------------------------------------------------- */

/**
 * @brief Initialzes FCCOB registers for Program phrase command.
 * @param PeripheralBase Pointer to a peripheral registers structure (peripheral
 *        base address). You can use the constant defined in the registers
 *        definition header file (<peripheral>_BASE_PTR) or the constant defined in
 *        the peripheral initialization component header file
 *        (<component_name>_DEVICE).
 * @param Address Flash address in the flash block. Must be 64-bit aligned. This
 *        parameter is a 24-bit value.
 * @param DWord0 First longword to be wtitten. This parameter is a 32-bit value.
 * @param DWord1 Second longword to be wtitten. This parameter is a 32-bit value.
 * @return Returns a value of void type.
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramPhrase_Init(<peripheral>_BASE_PTR, 1, 1, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_Init(PeripheralBase, Address, DWord0, DWord1) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_PROGRAM_PHRASE << 24), \
    (*(uint32_t*)&FTFE_FCCOB7_REG(PeripheralBase) = DWord0, \
    *(uint32_t*)&FTFE_FCCOBB_REG(PeripheralBase) = DWord1) \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_GetAddress
   ---------------------------------------------------------------------------- */
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_ProgramPhrase_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFE_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_SetAddress
   ---------------------------------------------------------------------------- */
 ...
 *        the peripheral initialization component header file
 *        (<component_name>_DEVICE).
 * @param Address Flash address in the flash block. Must be 128 bits aligned.
 *        This parameter is a 24-bit value.
 * @return Returns a value of void type.
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramPhrase_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_PROGRAM_LONGWORD << 24) \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_GetDWord0
   ---------------------------------------------------------------------------- */
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_ProgramPhrase_GetDWord0(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_GetDWord0(PeripheralBase) ( \
    (uint32_t)(*(uint32_t *)(void *)&FTFE_FCCOB7_REG(PeripheralBase)) \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_SetDWord0
   ---------------------------------------------------------------------------- */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramPhrase_SetDWord0(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_SetDWord0(PeripheralBase, Data) ( \
    *(uint32_t*)&FTFE_FCCOB7_REG(PeripheralBase) = Data \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_GetDWord1
   ---------------------------------------------------------------------------- */
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_ProgramPhrase_GetDWord1(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_GetDWord1(PeripheralBase) ( \
    (uint32_t)(*(uint32_t *)(void *)&FTFE_FCCOBB_REG(PeripheralBase)) \
  )

/* ----------------------------------------------------------------------------
   -- Cmd_ProgramPhrase_SetDWord1
   ---------------------------------------------------------------------------- */
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramPhrase_SetDWord1(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPhrase_SetDWord1(PeripheralBase, Data) ( \
    *(uint32_t*)&FTFE_FCCOBB_REG(PeripheralBase) = Data \
  )
 ...
 *        the peripheral initialization component header file
 *        (<component_name>_DEVICE).
 * @param Address Flash address in the flash block to be erased. Must be 128
 *        bits aligned. This parameter is a 24-bit value.
 * @return Returns a value of void type.
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_EraseFlashBlock_Init(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseFlashBlock_Init(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_ERASE_FLASH_BLOCK << 24) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_EraseFlashBlock_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseFlashBlock_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFE_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_EraseFlashBlock_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseFlashBlock_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_PROGRAM_LONGWORD << 24) \
  )
 ...
 *        the peripheral initialization component header file
 *        (<component_name>_DEVICE).
 * @param Address Flash address in the flash sector to be erased. Must be 128
 *        bits aligned. This parameter is a 24-bit value.
 * @return Returns a value of void type.
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_EraseSector_Init(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseSector_Init(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_ERASE_FLASH_SECTOR << 24) \
  )
 ...
 *      @code
 *      uint32_t result =
 *      FTFE_PDD_Cmd_EraseSector_GetAddress(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseSector_GetAddress(PeripheralBase) ( \
    (uint32_t)((*(uint32_t *)(void *)&(FTFE_FCCOB3_REG(PeripheralBase))) & 0xFFFFFF) \
  )
 ...
 *        the peripheral initialization component header file
 *        (<component_name>_DEVICE).
 * @param Address Flash address in the flash sector. Must be 128 bits aligned.
 *        This parameter is a 24-bit value.
 * @return Returns a value of void type.
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_EraseSector_SetAddress(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseSector_SetAddress(PeripheralBase, Address) ( \
    *(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = (Address) | (FTFE_PDD_PROGRAM_LONGWORD << 24) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sAllBlocks_Init(<peripheral>_BASE_PTR,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sAllBlocks_Init(PeripheralBase, MarginLevel) ( \
    *(uint16_t*)&FTFE_FCCOB1_REG(PeripheralBase) = MarginLevel | (FTFE_PDD_READ_1S_ALL_BLOCKS << 8) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_Cmd_Read1sAllBlocks_GetMarginLevel(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sAllBlocks_GetMarginLevel(PeripheralBase) ( \
    (FTFE_FCCOB1_REG(PeripheralBase)) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_Read1sAllBlocks_SetMarginLevel(<peripheral>_BASE_PTR,
 *      FTFE_PDD_READ_MARGIN_LEVEL_NORMAL);
 *      @endcode
 */
#define FTFE_PDD_Cmd_Read1sAllBlocks_SetMarginLevel(PeripheralBase, MarginLevel) ( \
    FTFE_FCCOB1_REG(PeripheralBase) = \
     (uint8_t)(MarginLevel) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_EraseAllBlocks_Init(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_EraseAllBlocks_Init(PeripheralBase) ( \
    *(uint8_t*)&FTFE_FCCOB0_REG(PeripheralBase) = FTFE_PDD_ERASE_ALL_BLOCKS \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ProgramPartition_Init(<peripheral>_BASE_PTR,
 *      FTFE_PDD_EEPROM_DATA_SIZE_0_B, FTFE_PDD_EEPROM_BACKUP_SIZE_0_KB);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ProgramPartition_Init(PeripheralBase, EepromDataSize, EepromBackupSize) ( \
    *(uint8_t*)&FTFE_FCCOB0_REG(PeripheralBase) = FTFE_PDD_PROGRAM_PARTITION, \
    (*(uint8_t*)&FTFE_FCCOB4_REG(PeripheralBase) = EepromDataSize, \
    *(uint8_t*)&FTFE_FCCOB5_REG(PeripheralBase) = EepromBackupSize) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_ReadPartition_Init(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ReadPartition_Init(PeripheralBase) ( \
    *(uint8_t*)&FTFE_FCCOB8_REG(PeripheralBase) = 0x00, \
    (*(uint32_t*)&FTFE_FCCOB3_REG(PeripheralBase) = 0x00800000 | 0xFC | (FTFE_PDD_READ_RESOURCE << 24), \
    *(uint8_t*)&FTFE_FCCOB4_REG(PeripheralBase) = FTFE_PDD_RESOURCE_IFR) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_Cmd_ReadPartition_GetEepromDataSize(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ReadPartition_GetEepromDataSize(PeripheralBase) ( \
    FTFE_FCCOB4_REG(PeripheralBase) \
  )
 ...
 *      @code
 *      uint8_t result =
 *      FTFE_PDD_Cmd_ReadPartition_GetEepromBackUpSize(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define FTFE_PDD_Cmd_ReadPartition_GetEepromBackUpSize(PeripheralBase) ( \
    FTFE_FCCOB5_REG(PeripheralBase) \
  )
 ...
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_SetFlexRAMFunction_Init(<peripheral>_BASE_PTR,
 *      FTFE_PDD_FLEXRAM_AS_RAM);
 *      @endcode
 */
#define FTFE_PDD_Cmd_SetFlexRAMFunction_Init(PeripheralBase, Function) ( \
    *(uint16_t*)&FTFE_FCCOB1_REG(PeripheralBase) = Function | (FTFE_PDD_SET_EERAM_FUCTION << 8) \
  )
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: FTFE_FCCOB4,
 *          FTFE_FCCOB5, FTFE_FCCOB6, FTFE_FCCOB7, FTFE_FCCOB8, FTFE_FCCOB9, FTFE_FCCOBA,
 *          FTFE_FCCOBB (depending on the peripheral).
 * @par Example:
 *      @code
 *      FTFE_PDD_Cmd_VerifyBackdoorAccessKey_Init(<peripheral>_BASE_PTR, 1, 1,
 *      1, 1, 1, 1, 1, 1);
 *      @endcode
 */
#define FTFE_PDD_Cmd_VerifyBackdoorAccessKey_Init(PeripheralBase, Key0, Key1, Key2, Key3, Key4, Key5, Key6, Key7) ( \
    *(uint8_t*)&FTFE_FCCOB0_REG(PeripheralBase) = FTFE_PDD_VERIFY_BACKDOOR_ACCESS_KEY, \
    ((FTFE_FCCOB4_REG(PeripheralBase) = \
     (uint8_t)(Key0)), \
    ((FTFE_FCCOB5_REG(PeripheralBase) = \
     (uint8_t)(Key1)), \
